...
export default function ConfirmedBooking() {
  ...
  // Derive necessary variables from formData for the template
...
// Format the time string (e.g., "17:30" -> "5:30 PM")
    ...
    <section className="confirmation-section">
      <div className="reservation-success">
        ...
        <p className="confirmation-message">
          Thank you for your confirmation, <strong>{nameText}</strong>.
          We look forward to having your party of <strong>{totalGuests} {guestText} </strong> on
          <strong> {dateStr} at {formData.time}</strong> at Little Lemon Chicago.
        </p>
        <br />
        <p className="confirmation-message">
